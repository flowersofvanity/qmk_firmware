 ...
 */
	...
	// Custom RGB Colours
	#define RGB_LEVIATHAN 0xae, 0xff, 0x00 // colour for matching keycaps
    #define RGB_DASHER 0xff, 0xff, 0xff // colour for matching keycaps
    ...
    const uint8_t LED_LIST_SHORTCUTS[] = {LED_DEL, LED_PGUP, LED_PGDN, LED_END };
